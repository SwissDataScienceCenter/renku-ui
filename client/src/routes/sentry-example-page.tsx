...
export default function SentryExamplePage() {
  ...
  useEffect(() => {
    Sentry.diagnoseSdkConnectivity().then(console.log);
  }, []);
      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            rel="noreferrer"
            href="https://renku.sentry.io/issues/?project=4509044025131088"
          >
            Issues Page
          </a>
          ...
          <a
            target="_blank"
            rel="noreferrer"
            href="https://docs.sentry.io/platforms/javascript/guides/react-router/"
          >
            read our docs
          </a>
          .
        ...
        <button
          ...
          onClick={async () => {
            await Sentry.startSpan(
              ...
              async () => {
                const res = await fetch("/ui/api/sentry-example-api");
                if (!res.ok) {
