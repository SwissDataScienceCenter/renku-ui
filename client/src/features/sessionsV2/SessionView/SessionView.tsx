...
function JobListItem({
  ...
  return (
    <AccordionItem data-cy="session-view-job-list-content">
  ...
  return (
    <div>
      <UncontrolledAccordion
        ...
        defaultOpen={openJobs}
        flush={true}
        stayOpen={true}
        toggle={(targetId: string) =>
          setOpenJobs((prev) => [...prev, targetId])
        }
      >
