...
import { ProjectActivateIndexingResponse, ProjectIndexingStatusResponse } from "./Project";
...
export const projectKgApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getProjectIndexingStatus: builder.query<ProjectIndexingStatusResponse, number>({
      query: (projectId) => {
        return {
...
export const { useActivateIndexingMutation, useGetProjectIndexingStatusQuery } = projectKgApi;
