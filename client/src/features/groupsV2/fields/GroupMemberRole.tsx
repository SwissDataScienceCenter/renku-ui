...
export interface GroupMemberRoleOption {
  label: string;
  value: string;
...
export const GROUP_MEMBER_ROLE_OPTIONS = [
  {
    ...
    label: "Viewer",
    description:
      "Can view all group content, including private projects and data connectors.",
  },
  {
    value: "editor",
    label: "Editor",
    description:
      "Can view all group content and add new projects and data connectors.",
  },
  {
    value: "owner",
    label: "Owner",
    description: "Can edit all group content and manage group membership.",
  },
] as readonly GroupMemberRoleOption[];
...
export default function GroupMemberRole({
  ...
  const onChange = useCallback(
    (newValue: SingleValue<GroupMemberRoleOption>) => {
...
const selectClassNames: ClassNamesConfig<GroupMemberRoleOption, false> = {
  control: ({ menuIsOpen }) =>
...
const selectComponents: SelectComponentsConfig<
  ...
  false,
  GroupBase<GroupMemberRoleOption>
> = {
