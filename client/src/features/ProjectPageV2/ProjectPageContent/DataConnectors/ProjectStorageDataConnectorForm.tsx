...
export default function ProjectStorageDataConnectorForm({
  project,
  toggle,
      ...
      {isLoading ? (
        ...
        <>
          <WarnAlert dismissible={false} timeout={0}>
            Project storage is already configured for this project. You can only
            setup 1 project storage per project.
          </WarnAlert>
        </>
      ) : (
        <>
