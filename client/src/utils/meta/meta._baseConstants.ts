...
export const _DEFAULT_META_TITLE_SEPARATOR: string = " · ";

export const _DEFAULT_META_DESCRIPTION: string =
...
export const _DEFAULT_META_IMAGE: string = renkuSocialCard;

export const _DEFAULT_META_LOCALE: string = "en";
