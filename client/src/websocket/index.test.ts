...
const fakeLocation = () => { return { pathname: "" }; };
...
describe("Test WebSocket functions", () => {
  ...
  it("Test retryConnection function", async () => {
    ...
    retryConnection("fakeUrl", model, fakeLocation, client as APIClient, notifications);
...
describe("Test WebSocket server", () => {
  it("Test setupWebSocket", async () => {
    ...
    setupWebSocket(
      webSocketURL.replace("localhost", "fake_host"), fullModel, fakeLocation, client as APIClient, notifications);
    ...
    setupWebSocket(webSocketURL, fullModel, fakeLocation, client as APIClient, notifications);
    await sleep(0.01);
