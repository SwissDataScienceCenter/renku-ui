  ...
  return (
    <div className="form-rk-green">
      <ButtonGroup key="controls" className="mt-2" size="sm">
        <Button onClick={toggleMode} active={mode === 0}>
          State 1
        </Button>
        <Button onClick={toggleMode} active={mode === 1}>
          State 2
        </Button>
      </ButtonGroup>
    </div>
...
function ButtonsGuide() {
  ...
  const buttonWithMenu = (
    <ButtonWithMenu size="sm" default={defaultButton}>
      {menuItem}
    </ButtonWithMenu>
  );
      ...
      <Table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <ExternalLink
                ...
                title="Link outside RenkuLab instance"
                showLinkIcon={true}
              />
            </td>
          </tr>
          <tr>
            ...
            <td>GoBackButton</td>
            <td>
              <GoBackButton label="Back to previous" />
            </td>
          </tr>
          <tr>
        ...
        <Table>
          ...
          <tbody>
            <tr>
              ...
              <td>InfoAlert</td>
              <td>
                <InfoAlert timeout={0}>Some information for you.</InfoAlert>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>WarnAlert</td>
              <td>
                <WarnAlert>Something that you should look out for.</WarnAlert>
              </td>
            </tr>
            <tr>
              ...
              <td>ErrorAlert</td>
              <td>
                <ErrorAlert>Your action failed.</ErrorAlert>
              </td>
            </tr>
          </tbody>
        </Table>
      ...
      <Table>
        ...
        <tbody>
          <tr>
            ...
            <td>
              Text to copy
              <Clipboard clipboardText="Text to copy" />
            </td>
          </tr>
          <tr>
