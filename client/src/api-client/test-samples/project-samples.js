  ...
  cells: [
    {
      ...
      source: [
        "df = weather_ch.read_data('../data/homog_mo_SMA.txt')\n",
        "df.head()",
      ],
    },
    {
      cell_type: "markdown",
      metadata: {},
      source: ["# Convert temperature to deviation from a reference"],
    },
    {
      cell_type: "code",
      execution_count: 23,
      ...
      outputs: [
        {
          data: {
            "text/plain": [
              "<matplotlib.axes._subplots.AxesSubplot at 0x1017e8780>",
            ],
          },
          execution_count: 5,
          metadata: {},
