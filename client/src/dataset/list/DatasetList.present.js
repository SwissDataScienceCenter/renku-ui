      ...
      <Col className="col-auto ms-2">
        ...
        <Fragment>
          ...
          >
            ...
            <DropdownMenu>
              <DropdownItem
                value={props.orderByValuesMap.TITLE}
              ...
              <DropdownItem
                value={props.orderByValuesMap.DATE}
                onClick={props.handlers.changeSearchDropdownOrder}
              >
              ...
              <DropdownItem
                value={props.orderByValuesMap.PROJECTSCOUNT}
                onClick={props.handlers.changeSearchDropdownOrder}
              >
      ...
      <Row className="justify-content-lg-between justify-content-md-center">
        <Col md={12}>
          <Form
            key="form"
            inline
            onSubmit={this.props.handlers.onSearchSubmit}
            ...
            <Col className="col-auto">
              {this.props.loading ? (
                <Button
                  color="rk-white"
                  id="cancelButton"
                  onClick={this.props.handlers.onCancelSearch}
                >
          ...
          <Col sm={12}>
            <FormText key="help" color="rk-text">
              {this.props.errorMessage} If you are not finding what you are
              looking for,{" "}
              <Button className="p-0 mb-1" color="link" id="toggler">
              ...
              <Card>
                <CardBody>
                  <small className="text-rk-text">
                    <p>
                      A wildcard can be used to broaden your search:
                      &apos;*&apos; for any number of characters or
                      &apos;?&apos; for one character. Quotation marks can be
                      used to make your search more specific. <br />
                    </p>
                    Examples:
                    <br />- &quot;ren*&quot; will match any word starting with
                    &quot;ren&quot;, like <i>renku</i> and <i>renga</i>
                    <br />- &quot;*ku&quot; will match any word that ends with
                    &quot;ku&quot;, like <i>renku</i> and <i>haiku</i>
                    <br />- &quot;re*ku&quot; will match any word that ends with
                    &quot;re&quot; and ends with &quot;ku&quot;, like{" "}
                    <i>renku</i> and <i>relotsofstuffku</i>
                    <br />- &quot;re?ku&quot; will match any five-letter word
                    that starts with re and ends with u., like <i>
                      renku
                    </i> and <i>renzu</i>
                    <br />- &quot;reku~2&quot; will perform a fuzzy search and
                    match any word with up to 2 changes to the string
                    &quot;reku&quot;, like <i>renku</i> and <i>akku</i>
                    <br />
                    - Quotation marks around a phrase will match a specific
                    phrase, like &quot;renku reproducibility&quot;.
                    <br />
                  </small>
                </CardBody>
              </Card>
          ...
          <Col className="d-flex pt-4">
            ...
            >
              <FontAwesomeIcon
                className={this.props.gridDisplay ? "" : "text-rk-pink"}
                icon={faBars}
              />
              <FontAwesomeIcon
                className={!this.props.gridDisplay ? "m-0" : "text-rk-pink m-0"}
                icon={faTh}
              />
            </Button>
          </Col>
...
class DatasetsRows extends Component {
  render() {
    ...
    const { currentPage, perPage, search, totalItems, gridDisplay } =
      this.props;
        ...
        <Row>
          <Col xs={12} md={12}>
            <Alert color="primary">
              ...
              is not a sub-path of <strong>/datasets</strong>. You can navigate
              through renku datasets using the tabs on top.
            </Alert>
          </Col>
        </Row>
      </Col>
    ...
    <Fragment>
      <Row className="pt-2 pb-3">
        <Col className="d-flex mb-2">
          <h2 data-cy="datasets-title" className="me-4">
            Renku Datasets
          </h2>
        </Col>
      </Row>
