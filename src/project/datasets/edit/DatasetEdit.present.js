...
function DatasetEdit(props) {
    ...
    return <div>
      {props.jobsStats.tooLong ?
        <div>
          ...
          </Link> in the project to see if commits for the changes in the dataset appear there.
          <br />
          <br />
        </div>
        : null
  ...
  return <FormPanel
    ...
    submitLoader={{ value: props.submitLoader, text: "Modifying dataset, please wait..." }}
